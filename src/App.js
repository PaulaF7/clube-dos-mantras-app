...
const SolarSystemBackground = memo(() => {
    ...
    const style = {
        ...
        alignItems: 'center',
        opacity: 0.3, // Reduz a opacidade para ficar no fundo
    };
